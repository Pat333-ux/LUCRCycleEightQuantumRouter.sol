...
contract LUCRCycleEightQuantumRouter {
    ...
    event CycleEightQuantumDeterminismRouted(
        bytes32 indexed key,
        bytes32 cycleEightQuantumDeterminismHash,
        uint256 blockNum
    );
    ...
    function routeCycleEightQuantumDeterminism(
        bytes32 key,
        bytes32 cycleEightQuantumDeterminismHash
        ...
        (bool ok, ) = t.module.call(
            abi.encodeWithSignature(
                "receiveCycleEightQuantumDeterminism(bytes32)",
                cycleEightQuantumDeterminismHash
            )
        );
        require(ok, "Routing failed");

        emit CycleEightQuantumDeterminismRouted(
            key,
            cycleEightQuantumDeterminismHash,
            block.number
        );
